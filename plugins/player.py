...
async def notforu(_, m: Message):
    k=await m.reply_sticker("CAACAgUAAxkBAAIaOmEJMTqDhCEFKG41xe8kJSRyo5KoAAJPAQACxUayLmMzoYw0Ru86IAQ")
    await mp.delete(k)
    await mp.delete(m)
...
async def not_chat(_, m: Message):
    buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://www.google.com/search?q=eagleanurag"),
            ]
         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/7c8f49c2c6a6b8883cb84.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Know About [Developer](https://www.google.com/search?q=eagleanurag) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
